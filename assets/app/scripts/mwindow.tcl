...
#	variable dia_desc
	...
	ttk::frame .root.pnd.left -padding "0 0 0 0"
...
#	wm geometry . 1000x600
	...
	# Edit submenu
	.mainmenu.edit add command -label [ mc2 "Undo" ] -underline 0 -command mwc::undo  
	.mainmenu.edit add command -label [ mc2 "Redo" ] -underline 0 -command mwc::redo 
	.mainmenu.edit add separator
	.mainmenu.edit add command -label [ mc2 "Copy" ] -underline 0 -command { mwc::copy ignored }  
	.mainmenu.edit add command -label [ mc2 "Cut" ] -underline 1 -command { mwc::cut ignored }  
	.mainmenu.edit add command -label [ mc2 "Paste" ] -underline 0 -command { mwc::paste ignored } 
	.mainmenu.edit add command -label [ mc2 "Select all" ] -underline 7 -command mwc::select_all  
	.mainmenu.edit add separator
	...
	.mainmenu.edit add command -label [ mc2 "Tidy up" ] -underline 0 -command { mwc::adjust_icon_sizes_current } 

	#.mainmenu.edit add separator
	#.mainmenu.edit add command -label [ mc2 "Diagram description..." ] -underline 10 -command mwc::dia_properties  -accelerator [ acc D ]
	.mainmenu.edit add separator
	.mainmenu.edit add command -label [ mc2 "Find" ] -underline 0 -command mw::show_search  
	.mainmenu.edit add command -label [ mc2 "Go to diagram..." ] -underline 0 -command mwc::goto  
	.mainmenu.edit add command -label [ mc2 "Go to item..." ] -underline 6 -command mwc::goto_item  
	.mainmenu.edit add command -label [ mc2 "Go to branch..." ] -underline 6 -command mwc::go_to_branch  
	...
	# View submenu
	.mainmenu.view add command -label [ mc2 "Zoom out" ] -underline 5 -command mw::zoomout 
	.mainmenu.view add command -label [ mc2 "Zoom 100%" ] -underline 5 -command mw::zoom100
	.mainmenu.view add command -label [ mc2 "Zoom in" ] -underline 5 -command mw::zoomin 
	...
	# DRAKON submenu
	.mainmenu.drakon add command -label [ mc2 "Verify" ] -underline 0 -command mw::verify 
	...
	bind $canvas <Double-ButtonPress-1> { mw::canvas_popup %W %X %Y %x %y }
