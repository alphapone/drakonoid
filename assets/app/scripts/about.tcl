...
proc about_init { window data } {
	...
	wm title $window [ mc2 "About Drakonoid" ]
	...
	set version [ mc2 "Drakonoid v.1.0\n" ]
	...
	$window.root.details insert 1.0 [ mc2 "Based on Drakon Editor v1.26 (Authors: Stepan Mitkin, Alexander Ilyin, Maas-Maarten Zeeman, Vasil Dyadov, Vasili Bachiashvili \n\n\nDRAKON helps people understand programs.\n\nDrakon Editor software is PUBLIC DOMAIN, with the exception of pdf4tcl and the Liberation fonts that have their own licenses.\n\nhttp://drakon-editor.sourceforge.net\ndrakon.editor@gmail.com\n)" ]
